...
var CONTRACTS_DOCS_REGISTRY = [
  ...
  },
  {
    ...
    defaultBody:
      ...
      + '<p><strong>AND:</strong> ________________________________________ (hereinafter called the "Tenant") &mdash; OF THE SECOND PART</p>'
      + '<h3>Whereas</h3>'
      ...
      + '<p>________________________________________________________ (hereinafter referred to as the "Premises").</p>'
      + '<h3>2. Duration</h3>'
      + '<p>This Agreement shall commence on the ______ day of ____________________, ______ and continue through the ______ day of ____________________, ______.</p>'
      ...
      + '<p>(a) The Tenant shall pay to the Housing Authority the rent or home ownership in the sum of $ ____________ dollars per month, payable on the first day of each month at the Housing Administration office or at such other place as the Housing Authority may hereafter direct. Payment will be made in cash or by cheque made payable to the Housing Authority of {nationName} Trust Account.</p>'
      ...
      + '<p>1. ______________________________&nbsp;&nbsp;&nbsp;&nbsp;2. ______________________________</p>'
      + '<p>3. ______________________________&nbsp;&nbsp;&nbsp;&nbsp;4. ______________________________</p>'
      ...
      + '<p>SIGNED, SEALED AND DELIVERED by ________________________________ the Housing Authority, in the presence of ________________________________</p>'
      + '<p>Name: ________________________________&nbsp;&nbsp;&nbsp;&nbsp;Witness Signature: ________________________________</p>'
      + '<p>SIGNED, SEALED AND DELIVERED by ________________________________ the Tenant, in the presence of ________________________________</p>'
      + '<p>Name: ________________________________&nbsp;&nbsp;&nbsp;&nbsp;Witness Signature: ________________________________</p>'
  },
  {
