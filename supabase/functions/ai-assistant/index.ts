...
const HOW_TO = [
  ...
  "",
  "Finance module (ED, CFO, and Finance roles only) - open the Finance page. It",
  "has sections for Tenants, Rent Ledger, Loans, Invoices/Charges, Payment",
  "Arrangements, Collections, Journal Entries, Transactions, and Reports. Common",
  "tasks:",
  "  - Add a tenant account: Tenants section > 'Add Tenant Account'. (Tenants are",
  "    normally synced automatically from a unit's assigned occupant; add here",
  "    only when needed.)",
  "  - Record a rent payment: Rent Ledger > '+ Record Payment' > choose the",
  "    tenant, amount, date and method, then save. For cash you can enter a",
  "    denomination breakdown.",
  "  - Set an opening balance: Rent Ledger > 'Set Opening Balance'.",
  "  - Post a charge / invoice: Invoices > '+ Invoice' (Post Charge / Invoice).",
  "    Use 'Batch Print' to print several at once. Void an invoice from its Void",
  "    action.",
  "  - Create a loan: Loans > '+ New Loan' (New Loan Application). Record",
  "    repayments with 'Record Loan Payment'; print the Loan Agreement.",
  "  - Set up a payment arrangement: Payment Arrangements > 'New Arrangement'.",
  "    Record installments with 'Record Payment'; print the Payment Arrangement",
  "    Agreement.",
  "  - Flag an account for collections: Collections > 'Flag Account'.",
  "  - Post a journal entry: Journal Entries > '+ New Entry'; debit/credit lines",
  "    must balance before it saves.",
  "  - Fix a mistake: do NOT delete. Use Reverse Payment / Reverse Entry / Adjust",
  "    Entry (or Void on an invoice) - these post a reversing/correcting entry.",
  "    Finance ledgers are append-only and audited.",
  "  - Transaction vouchers: open a Transaction Voucher from the Transactions",
  "    list to print or email it and lock signatures.",
  "  - Statements & reports: Finance Reports > 'Run Statements' generates tenant",
  "    statements; you can print an individual tenant statement.",
  "  - Export: each finance list (Rent Ledger, Loans, Journal, Arrangements,",
  "    Collections, Transactions, Tenants, Audit) has its own Export button.",
  "",
