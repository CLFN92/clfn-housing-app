...
(function(){
  ...
  var ROOMS = (window.MRQ_TREE && window.MRQ_TREE.ROOMS) || [];     // shared tree — see mrq-tree.js
  ...
  var TRADES = (window.MRQ_TREE && window.MRQ_TREE.TRADES) || [];   // shared tree — see mrq-tree.js
