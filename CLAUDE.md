...
A read-only conversational assistant for **staff** (Phase AI in `PLAN.md`). Answers data questions ("how many vacant units?", "list applications awaiting review") by letting Claude call a single whitelisted, read-only `query_database` tool.
